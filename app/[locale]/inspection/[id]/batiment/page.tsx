...
const SUBCATEGORIES = [
  {
    ...
    icon: Foundation,
    fields: [
      { id: 'type', label: 'Type de fondation', type: 'select', options: ['Béton coulé', 'Blocs de béton', 'Pierre', 'Autre'] },
  ...
  },
  {
    ...
    icon: Home,
    fields: [
      { id: 'materiau', label: 'Matériau principal', type: 'select', options: ['Bois', 'Acier', 'Béton', 'Mixte'] },
      { id: 'etat', label: 'État', type: 'select', options: ['Excellent', 'Bon', 'Moyen', 'Mauvais'] },
      { id: 'notes', label: 'Notes', type: 'text', multiline: true }
    ]
  },
  {
    ...
    icon: Roofing,
    fields: [
      { id: 'type', label: 'Type de toiture', type: 'select', options: ['Bardeau d\'asphalte', 'Tôle', 'Membrane élastomère', 'Autre'] },
  ...
  },
  {
    ...
    icon: Home,
    fields: [
      { id: 'materiau', label: 'Matériau', type: 'autocomplete', options: ['Brique', 'Vinyle', 'Bois', 'Pierre', 'Stucco', 'Aluminium', 'Composite'] },
      { id: 'etat', label: 'État', type: 'select', options: ['Excellent', 'Bon', 'Moyen', 'Mauvais'] },
      { id: 'notes', label: 'Notes', type: 'text', multiline: true }
    ]
  },
  {
    ...
    icon: Home,
    fields: [
      { id: 'type', label: 'Type d\'isolation', type: 'autocomplete', options: ['Laine minérale', 'Cellulose', 'Uréthane giclé', 'Polystyrène', 'Autre'] },
      { id: 'epaisseur', label: 'Épaisseur (pouces)', type: 'text' },
      { id: 'notes', label: 'Notes', type: 'text', multiline: true }
    ]
  },
  {
    ...
    icon: Window,
    fields: [
      { id: 'type_fenetres', label: 'Type de fenêtres', type: 'select', options: ['PVC', 'Bois', 'Aluminium', 'Mixte'] },
      { id: 'vitrage', label: 'Type de vitrage', type: 'select', options: ['Simple', 'Double', 'Triple'] },
      { id: 'etat', label: 'État', type: 'select', options: ['Excellent', 'Bon', 'Moyen', 'Mauvais'] },
      { id: 'notes', label: 'Notes', type: 'text', multiline: true }
    ]
  }
    ...
    <MaterialDashboardLayout>
      <Box sx={{ maxWidth: 1400, mx: 'auto', p: 3 }}>
        ...
        <Breadcrumbs separator={<NavigateNext fontSize="small" />} sx={{ mb: 3 }}>
          ...
          <Typography color="text.primary">Bâtiment</Typography>
        </Breadcrumbs>
                    ...
                    >
                      ...
                      >
                        <CardContent sx={{ p: 0, width: '100%', textAlign: 'center' }}>
                          <Icon sx={{
                            fontSize: 48,
                            color: isCompleted ? '#FF9800' : '#9e9e9e',
                            mb: 2
                          }} />
                          <Typography
                            variant="h6"
