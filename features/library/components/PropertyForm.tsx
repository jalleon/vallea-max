...
const propertySchema = z.object({
  ...
  status: z.enum(['Vendu', 'À vendre', 'Retiré', 'Expiré']).optional(),
  type_propriete: z.enum(['Unifamiliale', 'Condo', 'Plex', 'Terrain', 'Commercial']).optional(),
  ...
  type_sous_sol: z.enum(['Complet', 'Partiel', 'Vide sanitaire', 'Aucun']).optional(),
